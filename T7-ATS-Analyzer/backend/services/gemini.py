...
def score_content(resume_json: dict, target_role: str = "", experience_level: str = "Professional (Experienced)", model: str | None = None) -> dict:
    ...
    return _generate_json(
        contents=(
            ...
            f"CRITICAL: The user's chosen experience level is: '{experience_level}'. "
            f"Write a comprehensive, realistic 'level_assessment' explaining THEIR readiness for this level. "
            f"IMPORTANT: Write this assessment addressing the user directly in the second person (e.g., 'You are a strong applicant...', 'Your resume shows...'). Do NOT use 3rd person like 'The candidate'. "
            f"ANTI-HALLUCINATION & REALITY CHECK: Do not give 'fake motivation' or sugarcoat the feedback. Be strictly grounded in reality and provide a harsh but fair real-world explanation. "
